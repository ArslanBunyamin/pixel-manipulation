...
var shade = "$@B%8&WM#*oahkbdpqwmZO0QLCJUYXzcvunxrjft/\|()1{}[]?-_+~<>i!lI;:," + '"' + "^`'. ";
...
function draw() {
    ...
    if (!ctx)
        return alert("html canvas desteklenmiyor!");
    ctx.clearRect(0, 0, canvas.width, canvas.height);
    var videoWidth = video.videoWidth / 12;
    var videoHeight = video.videoHeight / 12;
